...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21895 = c;
var G__21895__$1 = (((G__21895 == null))?null:G__21895.prototype);
if((G__21895__$1 == null)){
return null;
} else {
return G__21895__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21900 = c;
var G__21900__$1 = (((G__21900 == null))?null:G__21900.prototype);
if((G__21900__$1 == null)){
return null;
} else {
return G__21900__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__21918__delegate = function (args){
...
var G__21918 = function (var_args){
var args = null;
...
while (G__21919__i < G__21919__a.length) {G__21919__a[G__21919__i] = arguments[G__21919__i + 0]; ++G__21919__i;}
  args = new cljs.core.IndexedSeq(G__21919__a,0,null);
} 
return G__21918__delegate.call(this,args);};
G__21918.cljs$lang$maxFixedArity = 0;
G__21918.cljs$lang$applyTo = (function (arglist__21920){
var args = cljs.core.seq(arglist__21920);
return G__21918__delegate(args);
});
...
var or__5002__auto__ = (function (){var G__21902 = c;
var G__21902__$1 = (((G__21902 == null))?null:G__21902.constructor);
if((G__21902__$1 == null)){
return null;
} else {
return G__21902__$1.displayName;
}
})();
...
var G__21903 = c;
var G__21903__$1 = (((G__21903 == null))?null:G__21903.constructor);
if((G__21903__$1 == null)){
return null;
} else {
return G__21903__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21904 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21905 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21905);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21904);
}});
...
var c = this;
var G__21908_21926 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21908_21926 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21908_21926);
}
...
var renders_21929 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21930 = cljs.core.first(cljs.core.vals(renders_21929));
...
if((cljs.core.count(renders_21929) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21929))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21930)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21930], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21909 = o;
reagent.impl.component.goog$module$goog$object.set(G__21909,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21910 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21911 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21911);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21910);
}});
...
var vec__21912 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21912,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21912,(1),null);
...
var G__21915 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21915 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21915);
}
});
}),[]);
