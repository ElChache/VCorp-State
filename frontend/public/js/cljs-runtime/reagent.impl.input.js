...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__8183){
var map__8184 = p__8183;
var map__8184__$1 = cljs.core.__destructure_map(map__8184);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8184__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__8195 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__8196 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__8196);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__8195);
}}));
} else {
...
(jsprops.onChange = (function (p1__8222_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__8222_SHARP_);
}));
