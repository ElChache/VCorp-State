...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__23428 = cljs.core.second(format);
var G__23429 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__23428,G__23429) : ajax.easy.keyword_response_format_element.call(null,G__23428,G__23429));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__23430 = format;
var G__23430__$1 = (((G__23430 instanceof cljs.core.Keyword))?G__23430.fqn:null);
switch (G__23430__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23433_SHARP_){
return ajax.easy.keyword_response_format_element(p1__23433_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__23438){
var map__23439 = p__23438;
var map__23439__$1 = cljs.core.__destructure_map(map__23439);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23439__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23439__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23439__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__23443){
var vec__23445 = p__23443;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23445,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23445,(1),null);
var fexpr__23449_23477 = (cljs.core.truth_(ok)?h:e);
(fexpr__23449_23477.cljs$core$IFn$_invoke$arity$1 ? fexpr__23449_23477.cljs$core$IFn$_invoke$arity$1(result) : fexpr__23449_23477.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__23457){
var map__23458 = p__23457;
var map__23458__$1 = cljs.core.__destructure_map(map__23458);
var opts = map__23458__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23458__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23458__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23458__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23458__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23458__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
