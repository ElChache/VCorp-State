...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__23521 = cljs.core.second(format);
var G__23522 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__23521,G__23522) : ajax.easy.keyword_response_format_element.call(null,G__23521,G__23522));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23530_SHARP_){
return ajax.easy.keyword_response_format_element(p1__23530_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__23531){
var map__23532 = p__23531;
var map__23532__$1 = cljs.core.__destructure_map(map__23532);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23532__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23532__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23532__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__23533){
var vec__23534 = p__23533;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23534,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23534,(1),null);
var fexpr__23537_23543 = (cljs.core.truth_(ok)?h:e);
(fexpr__23537_23543.cljs$core$IFn$_invoke$arity$1 ? fexpr__23537_23543.cljs$core$IFn$_invoke$arity$1(result) : fexpr__23537_23543.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__23538){
var map__23539 = p__23538;
var map__23539__$1 = cljs.core.__destructure_map(map__23539);
var opts = map__23539__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23539__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23539__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23539__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23539__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23539__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
