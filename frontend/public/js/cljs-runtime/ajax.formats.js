...
var G__10934 = request;
var G__10935 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__10934,G__10935) : ajax.formats.get_format.call(null,G__10934,G__10935));
} else {
...
return cljs.core.some((function (p1__10956_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__10956_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__10957){
var map__10958 = p__10957;
var map__10958__$1 = cljs.core.__destructure_map(map__10958);
var request = map__10958__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10958__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__10961 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__10961.cljs$core$IFn$_invoke$arity$1 ? fexpr__10961.cljs$core$IFn$_invoke$arity$1(response) : fexpr__10961.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__10963){
var map__10964 = p__10963;
var map__10964__$1 = cljs.core.__destructure_map(map__10964);
var request = map__10964__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10964__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__10962_SHARP_){
return ajax.formats.get_accept_entries(request,p1__10962_SHARP_);
