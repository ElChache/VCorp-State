...
var G__23327 = request;
var G__23328 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__23327,G__23328) : ajax.formats.get_format.call(null,G__23327,G__23328));
} else {
...
return cljs.core.some((function (p1__23333_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__23333_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__23338){
var map__23339 = p__23338;
var map__23339__$1 = cljs.core.__destructure_map(map__23339);
var request = map__23339__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23339__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__23344 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__23344.cljs$core$IFn$_invoke$arity$1 ? fexpr__23344.cljs$core$IFn$_invoke$arity$1(response) : fexpr__23344.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__23346){
var map__23347 = p__23346;
var map__23347__$1 = cljs.core.__destructure_map(map__23347);
var request = map__23347__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23347__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__23345_SHARP_){
return ajax.formats.get_accept_entries(request,p1__23345_SHARP_);
