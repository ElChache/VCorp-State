...
var G__23433 = request;
var G__23434 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__23433,G__23434) : ajax.formats.get_format.call(null,G__23433,G__23434));
} else {
...
return ajax.formats.content_type_matches(content_type,p1__23438_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__23444){
var map__23445 = p__23444;
var map__23445__$1 = cljs.core.__destructure_map(map__23445);
var request = map__23445__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23445__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__23447 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__23447.cljs$core$IFn$_invoke$arity$1 ? fexpr__23447.cljs$core$IFn$_invoke$arity$1(response) : fexpr__23447.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__23449){
var map__23450 = p__23449;
var map__23450__$1 = cljs.core.__destructure_map(map__23450);
var request = map__23450__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23450__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__23448_SHARP_){
return ajax.formats.get_accept_entries(request,p1__23448_SHARP_);
