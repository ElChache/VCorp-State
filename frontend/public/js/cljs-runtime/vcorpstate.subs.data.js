...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__12573){
var vec__12574 = p__12573;
var slug = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12574,(0),null);
var collection = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12574,(1),null);
...
var ready_docs = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__12568_SHARP_){
return new cljs.core.Keyword(null,"ready","ready",1086465795).cljs$core$IFn$_invoke$arity$1(p1__12568_SHARP_);
}),collection_docs));
var all_ready_QMARK_ = (((total_docs > (0))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(ready_docs,total_docs)));
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,slug,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(collection,new cljs.core.Keyword(null,"total-documents","total-documents",-1425113107),total_docs,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"ready-documents","ready-documents",-1639585393),ready_docs,new cljs.core.Keyword(null,"all-documents-ready?","all-documents-ready?",-1169302192),all_ready_QMARK_], 0)));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("data","loaded?","data/loaded?",-1132268076),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("data","collections","data/collections",-2111559119)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("data","jobs","data/jobs",-308433530)], null),(function (p__12577,_){
var vec__12578 = p__12577;
var collections = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12578,(0),null);
var jobs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12578,(1),null);
...
var completed_jobs = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__12581_SHARP_){
return new cljs.core.Keyword(null,"completed","completed",-486056503).cljs$core$IFn$_invoke$arity$1(cljs.core.second(p1__12581_SHARP_));
}),jobs));
