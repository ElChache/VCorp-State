...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("data","loaded?","data/loaded?",-1132268076),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("data","collections","data/collections",-2111559119)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("data","jobs","data/jobs",-308433530)], null),(function (p__12614,_){
var vec__12615 = p__12614;
var collections = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(0),null);
var jobs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12615,(1),null);
...
var completed_jobs = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__12618_SHARP_){
return new cljs.core.Keyword(null,"completed","completed",-486056503).cljs$core$IFn$_invoke$arity$1(cljs.core.second(p1__12618_SHARP_));
}),jobs));
