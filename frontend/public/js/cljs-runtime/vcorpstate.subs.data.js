...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__14935){
var vec__14936 = p__14935;
var slug = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14936,(0),null);
var collection = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14936,(1),null);
...
var ready_docs = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__14930_SHARP_){
return new cljs.core.Keyword(null,"ready","ready",1086465795).cljs$core$IFn$_invoke$arity$1(p1__14930_SHARP_);
}),collection_docs));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("data","agents","data/agents",-1115506098),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"agents","agents",-1112413700)], null));
})], 0));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("data","loaded?","data/loaded?",-1132268076),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("data","collections","data/collections",-2111559119)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("data","jobs","data/jobs",-308433530)], null),(function (p__14939,_){
var vec__14940 = p__14939;
var collections = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14940,(0),null);
var jobs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14940,(1),null);
...
var completed_jobs = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__14943_SHARP_){
return new cljs.core.Keyword(null,"completed","completed",-486056503).cljs$core$IFn$_invoke$arity$1(cljs.core.second(p1__14943_SHARP_));
}),jobs));
