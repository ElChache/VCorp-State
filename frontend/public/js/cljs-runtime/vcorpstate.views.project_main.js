...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (_this,p__15249){
var vec__15250 = p__15249;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15250,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15250,(1),null);
var vec__15253 = prev_props;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15253,(0),null);
var prev_project_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15253,(1),null);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex h-screen bg-gray-50",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
})], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [vcorpstate.components.sidebar.sidebar], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-1 h-full transition-all duration-300"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [vcorpstate.components.graph.graph_component], null)], null)], null);
})], null));
});
