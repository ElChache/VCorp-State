...
return vcorpstate.routes.parse_url.cljs$core$IFn$_invoke$arity$1(window.location.pathname);
}));
...
if(clojure.string.starts_with_QMARK_(path,"/project/")){
var id_str = cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(path,/\//));
...
var G__6718 = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(route);
var G__6718__$1 = (((G__6718 instanceof cljs.core.Keyword))?G__6718.fqn:null);
switch (G__6718__$1) {
case "home":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6718__$1)].join('')));

}
});
vcorpstate.routes.navigate_to_route_BANG_ = (function vcorpstate$routes$navigate_to_route_BANG_(route){

var url = (function (){var G__6719 = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(route);
var G__6719__$1 = (((G__6719 instanceof cljs.core.Keyword))?G__6719.fqn:null);
switch (G__6719__$1) {
case "home":
return "/";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6719__$1)].join('')));
...
return window.addEventListener("popstate",vcorpstate.routes.handle_route_change);
});
