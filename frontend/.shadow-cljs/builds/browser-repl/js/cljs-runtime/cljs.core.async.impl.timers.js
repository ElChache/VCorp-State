...
var i_14490 = (self__.level + (1));
while(true){
if((i_14490 <= (new_level + (1)))){
(update[i_14490] = self__.header);

var G__14495 = (i_14490 + (1));
i_14490 = G__14495;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14496 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14496[i]));
} else {
x__$2.forward.push((((i < links_14496.length))?(links_14496[i]):null));
}

if((i < links_14496.length)){
(links_14496[i] = x__$2);
} else {
links_14496.push(x__$2);
}
...
if((x__$1 === (((i_14498 < links_14499.length))?(links_14499[i_14498]):null))){
...
if(cljs.core.truth_(nx)){
var G__14509 = nx;
var G__14510 = (level__$1 - (1));
x = G__14509;
level__$1 = G__14510;
continue;
} else {
var G__14511 = x;
var G__14512 = (level__$1 - (1));
x = G__14511;
level__$1 = G__14512;
continue;
}
