 ...
 (fn [db [_ event]]
   (let [event-type (:type event)]
     (case event-type
       ...
       "agent_created" (rf/dispatch [:data/agent-created event])
       "agent_updated" (rf/dispatch [:data/agent-updated event])
       "agent_deleted" (rf/dispatch [:data/agent-deleted event])
